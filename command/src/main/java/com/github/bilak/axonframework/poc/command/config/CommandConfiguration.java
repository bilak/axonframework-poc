...
public class CommandConfiguration {
    ...
    @Bean
    public AggregateAnnotationCommandHandler<User> userCommandHandler(@Qualifier("userEventSourcingRepository") EventSourcingRepository<User> eventSourcingRepository) {
